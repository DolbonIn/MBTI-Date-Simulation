...
STEP_INSTRUCTIONS = {
    ...
    10: "10: As the date nears its end, the ENTP should summarize their feelings about the date and leave a lasting impression on the user. Include an ENTP-style joke in the final appeal to make it memorable."
}
